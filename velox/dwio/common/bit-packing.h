...
class BitPacking {
 public:
  ...
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD(int bit_width,
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_0(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_1(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_2(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_3(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_4(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_5(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_6(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_7(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_8(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_9(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_10(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_11(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_12(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_13(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_14(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_15(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_16(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_17(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_18(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_19(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_20(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_21(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_22(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_23(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_24(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_25(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_26(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_27(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_28(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_29(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_30(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_31(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesSIMD_32(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);


  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL(int bit_width,
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_0(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_1(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_2(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);

  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_3(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_4(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_5(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_6(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_7(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_8(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_9(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_10(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_11(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_12(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_13(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_14(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_15(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_16(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_17(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_18(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_19(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_20(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_21(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_22(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_23(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_24(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_25(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_26(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_27(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_28(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_29(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_30(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_31(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
  template <typename OutType>
  static std::pair<const uint8_t*, int64_t> UnpackValuesQPL_32(
      const uint8_t* __restrict__ in, int64_t in_bytes, int64_t num_values,
      OutType* __restrict__ out);
 private:
