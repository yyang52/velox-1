...
/**
 * @brief Contains implementation of functions for unpacking 17..32-bit data to
 * dwords
 * @date 08/02/2020
 *
...
inline const uint8_t* unpack_Nu32u(
...
// ********************** 17u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_17u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
template <typename OutType>
inline const uint8_t* unpack_18u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 19u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_19u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 20u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_20u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 21u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_21u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 22u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_22u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 23u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_23u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 24u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_24u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 25u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_25u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 26u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_26u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 27u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_27u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 28u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_28u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 29u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_29u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 30u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_30u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 31u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_31u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
// ********************** 32u ****************************** //
template <typename OutType>
inline const uint8_t* unpack_32u32u(
    const uint8_t* src_ptr,
    uint32_t values_to_read,
    OutType* dst_ptr);
...
inline const uint8_t* unpack_32u32u(
    ...
    uint32_t values_to_read,
    uint32_t* dst_ptr) {
  uint64_t numBytes = values_to_read * 4;
  memcpy(dst_ptr, src_ptr, numBytes);
...
inline const uint8_t* unpack_32u32u(
  ...
  if (values_to_read >= 16u) {
    while (values_to_read >= 16u) {
      __m512i src = _mm512_loadu_epi8(src32u_ptr);
